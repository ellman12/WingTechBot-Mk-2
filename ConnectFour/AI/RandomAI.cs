...
namespace ConnectFour
{
    ...
    {
        private readonly Random random = new(); // only needed for random moves
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Style", "IDE0022:Use expression body for methods", Justification = "Makes comments clearer")] // ignore this
